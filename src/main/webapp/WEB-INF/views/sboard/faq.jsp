                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-collapse collapse" id="collapseThree">
                                    <div class="panel-body">
                                    	디아크 체험 취소 연락주시구요다음주에 다시 신청하셔야 합니다.오늘도 좋은하루 되세요
									</div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-collapse collapse" id="collapseFive">
                                    <div class="panel-body">
                                    	체험신청은 웹, 모바일에서 모두 신청하실 수 있습니다.다만 신청마감시에는 두 곳 모두에서 이용하실 수 없습니다. 
										최근에는 체험신청이 1분 이내에 마감이 되고 있습니다ㅠ_ㅠ 그만큼 마감이 빨리 진행되오니, 다음 신청시 참고하셔서 신청해주세요!! 
									</div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-collapse collapse" id="collapseSix">
                                    <div class="panel-body">
                                 	   17년도 전시대관일정은 마감되었습니다. ^^
										18년도 대관신청은 아직 받고 있지 않으며, 11월 이후에 신청 받을 예정입니다.11월 이후에 053-585-0916~7번으로 문의주세요~
									</div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-collapse collapse" id="collapseSeven">
                                    <div class="panel-body">
                                    	소방대피로를 현황판으로 제작하여, 따로 안내하고 있지는 않습니다만, 내부 천장에 비상구 안내표시가 설치되어있습니다. 평상시 이용하는 엘리베이터와 계단 외에 비상계단이 마련되어있고, 각층 마다 소화전, 소화기, 스프링쿨러가 설치되어있습니다. 저희 디아크 직원들은 관할 소방서에서 정기적인 소방훈련을 받고 있으니, 위급 상황 발생시 직원의 안내에 따라 출입구 또는 옥상으로 대피하시면 되겠습니다.(불의 발화지점에 따라 안내) 관람객 여러분들의 안전을 위해 항상 최선을 다하는 디아크가 되겠습니다. 감사합니다. ^^ </div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                ...
                                <div class="panel-collapse collapse" id="collapseEight">
                                    <div class="panel-body">
                                    	안녕하세요~디아크 문화안내사입니다.문의주신 내용 업체에 한번 연락해보시면 자세한 사항 말씀해 주실것 같습니다.
										감사합니다 ^^ 업체전화번호: 010-3567-8656
									</div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-collapse collapse" id="collapseNine">
                                    <div class="panel-body">
                                    	디아크에서 진행하는 몽키매직쇼는 무료관람이며 15:00(오후3시)에 시작합니다. ^^
										명절 잘 보내세요 새해 복 많이 받으시구요 ^^ 더 궁금하신 사항은 디아크 053-585-0916~7 로 전화 부탁드립니다. ~~^^
									</div>
                                </div>
                            </div>
                            <div class="panel panel-default">
                                ...
                                <div class="panel-collapse collapse" id="collapsetweleve">
                                    <div class="panel-body">
                                    	등업은 필요하지않습니다~!! 오전 11시부터 전회원 신청가능하십니다~!!
                                    </div>
                                </div>
                            </div>
                        </div>
